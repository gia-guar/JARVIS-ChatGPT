...
text1 ="""user: What are transformers architecture and how can they be used in segmentation?
...
text2 = """system: You are a helpful assistant and you will answer in paragraphs. A paragraph can be as long as 20 words. user: What can you tell me about electric propulsion in rockets?
...
key = "Physics and Space exploration"
print('text 1 about AI, learning and transformers:')
print(f"affinity with {key}: {search.compute_similarity(key, text1)}")
print('\ntext 2 about nuclear propulsion in space flights')
print(f"affinity with {key}: {search.compute_similarity(key, text2)}")

# create a DataFrame of the whole folder to be analyzed
print(search.produce_folder_tags(update=False)) 

# use the csv DataFrame to look for semantic matches between key and files 
print(search.accurate_search(key, path=os.path.join('saved_chats'), from_csv=True))