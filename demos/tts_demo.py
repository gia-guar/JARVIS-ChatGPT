...
tts.tts_to_file(text=TEXT, speaker_wav=os.path.join('E:\Data\documenti\PROGRAMMAZIONE\ChatGPT','voices','JARVIS','PaulBettanyLongMP3.mp3'), language="en", file_path="output.wav")
